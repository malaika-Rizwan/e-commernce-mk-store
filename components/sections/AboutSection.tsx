...
export function AboutSection() {
  return (
    <section id="about" className="min-h-screen bg-pageBg" style={{ backgroundColor: '#BEB9B4' }} aria-labelledby="about-heading">
      <ScrollReveal>
      ...
      >
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          <div>
            <h2 id="our-story-heading" className="text-3xl font-bold text-darkBase">
              Our Story
            </h2>
      ...
      >
        <h2 id="values-heading" className="text-center text-3xl font-bold text-darkBase">
          Our Values
        </h2>
      ...
      >
        <h2 id="team-heading" className="text-center text-3xl font-bold text-darkBase">
          Meet Our Team
        </h2>
      ...
      {/* Section 6 — CTA */}
      <section className="w-full bg-darkBase py-20" aria-labelledby="cta-heading">
