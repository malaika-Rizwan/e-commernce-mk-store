...
export function ContactSection() {
  return (
    <section id="contact" className="min-h-screen w-full py-20 sm:py-24" style={{ backgroundColor: '#E6E2DE' }} aria-labelledby="contact-heading">
      <ScrollReveal>
        <header className="w-full pb-12 text-center px-4 sm:px-6" aria-labelledby="contact-heading">
          <h1 id="contact-heading" className="text-3xl font-bold tracking-tight text-[#49474D] sm:text-4xl md:text-5xl">
            Get In Touch
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-lg text-[#49474D]/80">
            We&apos;d love to hear from you. Our team is always here to help.
          </p>
          <div className="mx-auto mt-6 h-1 w-16 rounded-full" style={{ backgroundColor: '#EBBB69' }} aria-hidden />
        </header>
      </ScrollReveal>

      <section className="w-full py-12 px-4 sm:px-6" aria-label="Contact options">
